...
public class Appels_emis extends Activity implements OnGestureListener, TextToSpeech.OnInitListener, OnClickListener, OnLongClickListener{
	private TextToSpeech tts;
	private TextView appel_emis;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titre.setText("Appels émis");
		
		appel_emis = (TextView) findViewById(R.id.tv_app);
		appel_emis.setText("");
	...
	public void onInit(int status) {
		if (status == TextToSpeech.SUCCESS) {
			...
			speakOut("Appels émis, défiler pour parcourir");
	...
	public void onLongPress(MotionEvent arg0) {
		...
		Contacts.deactivate();
		Intent int_choix = new Intent(Appels_emis.this, Menu_choix_journal.class);
